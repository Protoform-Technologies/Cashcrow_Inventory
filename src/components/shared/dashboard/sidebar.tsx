    ...
    return (
        <>
            <aside className={`w-64 border-r flex flex-col fixed h-full z-[60] bg-[#265136] border-white/10 text-white transition-transform duration-300 lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                {/* LOGO */}
                <div className="py-2 px-4 flex items-center justify-center border-b border-white/5 mx-2">
                ...
                <nav className="flex-1 px-3 py-2 space-y-0.5 overflow-y-auto overflow-x-hidden">
                        ...
                        .map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={`flex items-center gap-3 px-4 py-2.5 md:py-3 rounded-xl font-medium transition-all group duration-200 ${isActive
                    ...
                    <Link
                        ...
                        onClick={() => setIsOpen(false)}
                        className={`flex items-center gap-3 px-4 py-2.5 md:py-3 rounded-xl font-medium transition-all group duration-200 mt-0.5 ${pathname.includes("/profile")
                            ? "bg-white/10 text-white shadow-sm ring-1 ring-white/20"
                            : "text-[#d0e8d6] hover:bg-white/5 hover:text-white"
                            }`}
                    >
                ...
                {/* LOGOUT */}
                <div className="p-3 md:p-4 border-t border-white/10 mt-auto">
                    <button
                        onClick={() => setShowLogoutModal(true)}
                        className="flex w-full items-center gap-3 px-4 py-2.5 md:py-3 text-[#d0e8d6] hover:bg-red-500/20 hover:text-red-300 rounded-xl font-medium transition-all group"
                    >
