      ...
      <nav className="sticky top-0 z-50 w-full border-b border-cashcrow-accent bg-cashcrow-bg/80 backdrop-blur-md">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <Link href="/login" className="hidden sm:block text-sm font-medium text-cashcrow-primary">Log in</Link>
            <Link href="/signup" className="rounded-full bg-cashcrow-primary px-5 py-2 text-sm font-semibold text-white shadow-lg hover:bg-cashcrow-lightgreen transition-all hover:scale-105 active:scale-95">
              Get Started
            </Link>
          </div>
        </div>
